...
type RoomMember struct {
	ID        int64                 `gorm:"primaryKey;autoIncrement;comment:'关系主键ID'"`
	...
	DeletedAt soft_delete.DeletedAt `gorm:"type:bigint unsigned;uniqueIndex:uk_room_user_deleted,priority:3;softDelete:milli;comment:'毫秒级软删除标记'"`
}
